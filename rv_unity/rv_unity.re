...
= はじめに
== この本について
「Unityを使えば簡単にゲームを作れますよ！」と聞いてダウンロードし，入門サイトを見ながら簡単なゲームはどうにかできたけど，
...
アーケード，と言ってもWiiリモコンと自作ペダルのみですがシンプルな操作性は子どもでも遊びやすくウケがいいです(体験談)．

なお，この本ではUnity画面の見方や操作など基本的な部分や機能の説明は省略することが多いです．
プログラミングのC#における基本文法も説明を省かせていただくので，分からない場合適宜調べるかそのレベルに至ってない場合，一旦入門サイトでミニゲームを作ってみることをおすすめします．
