...
= マップのモデリング
さて，2章ではゲームの基本システムを作成しました．しかし地平線やただの地形だけの背景だと，どうしても寂しいですよね．

そこでゲームには不可欠なマップの作成を，今回はモデリングによるオリジナルマップにて紹介しようと思います．
本書で扱うゲームはどんなマップでも基本的に遊べますので，この章はスキップしてアセットストアの無料マップを使うのも大丈夫です．
