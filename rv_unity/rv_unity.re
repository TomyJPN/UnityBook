...
アーケード，と言ってもWiiリモコンと自作ペダルのみの単純なものですが，シンプルかつ直感的な操作性は子どもや非ゲーマーでも楽しめると思います．

なお，この本ではUnity画面の見方や操作など基本的な部分や機能の説明は省略することが多いです．
...
: Unity2018.3.2f1
 今回のメインで使うゲームエンジン．3Dゲームを作るのに最適で個人からゲーム会社まで広い場所で使われています．以前はUnity4,Unity5のような言い方でしたがと201xというバージョンナンバリングに変わりました．
...
そこでゲームには不可欠なマップの作成ですが今回はモデリングによるオリジナルマップ作成を簡単にですが紹介しようと思います．
この本で扱うゲームはどんなマップでも基本遊べますのでこの章はスキップしてアセットストアの無料マップを使うのも大丈夫です．
...
インターネットミームで海底都市SAGAとかありますが筆者のゲームでは屍都市SAGAです．何にでもなれるのが佐賀の魅力だと思います(？)．

なお，この章では佐賀駅を例として追っていきますが最寄り駅，学校，勤務先など任意の荒らしたい舞台にしちゃっていいです．むしろそうしましょう．
...
しかし基本的に立方体の押し出しの組み合わせで作る程度ですと最低限の操作さえ把握していれば作ることができます．

以下，筆者が良く使うショートカットキー一覧です．
